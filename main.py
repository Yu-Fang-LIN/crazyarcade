...
def game(person1, person2):
    ...
    bird = {'right':['角色三 大笨鳥\大笨鳥 右轉 reset.png', '角色三 大笨鳥\大笨鳥 右轉 1.png', '角色三 大笨鳥\大笨鳥 右轉 2.png'],
        'left':['角色三 大笨鳥\大笨鳥 左轉 reset.png', '角色三 大笨鳥\大笨鳥 左轉 1.png', '角色三 大笨鳥\大笨鳥 左轉2.png'],
        'up':['角色三 大笨鳥\大笨鳥 往上 reset.png', '角色三 大笨鳥\大笨鳥 往上 1.png', '角色三 大笨鳥\大笨鳥 往上 2.png'],
        'down':['角色三 大笨鳥\大笨鳥 往下 reset (初始).png', '角色三 大笨鳥\大笨鳥 往下 1.png', '角色三 大笨鳥\大笨鳥 往下 2.png'],
        'still':['角色三 大笨鳥\大笨鳥 右轉 reset.png', '角色三 大笨鳥\大笨鳥 右轉 reset.png', '角色三 大笨鳥\大笨鳥 右轉 reset.png']}
    character = {1:kp, 2:cmkuan, 3:bird}
    props = ['道具包\地雷.png', '道具包\威力藥水.png', '道具包\炸彈.png', '道具包\槍槍.png', '道具包\加速藥水.png']   

    # Define a player object by extending pygame.sprite.Sprite
    # The surface drawn on the screen is now an attribute of 'player'
    class Player(pygame.sprite.Sprite):
        def __init__(self, x, y, color, name, person):
    ...
    # create players
    player1, player2 = Player(411, 166, (13, 217, 84), 'player1', character[person1]), Player(891, 486, (31, 46, 181), 'player2', character[person2])
    ...
    while running:
        ...
        # 載入圖片
        player1.anim(player1.person)
        player2.anim(player2.person)
        for mine in mines:
        ...
        bomb_capcity1 = pygame.font.SysFont("站酷小薇logo体", 25)
        text3 = bomb_capcity1.render("wasd:上下左右", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (12, 400))
        text3 = bomb_capcity1.render("Lshift:放bomb", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (12, 430))
        text3 = bomb_capcity1.render("z:gun", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (12, 460))
        text3 = bomb_capcity1.render("x:地雷", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (12, 490))
        text3 = bomb_capcity1.render("f:拿刀", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (12, 520))
        text3 = bomb_capcity1.render("方向鍵:上下左右", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (1052, 400))
        text3 = bomb_capcity1.render("Rshift:放bomb", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (1052, 430))
        text3 = bomb_capcity1.render("Ctrl:gun", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (1052, 460))
        text3 = bomb_capcity1.render("Alt:地雷", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (1052, 490))
        text3 = bomb_capcity1.render("/:拿刀", True, (0, 108, 224), (0,0,0))
        screen.blit(text3, (1052, 520))
