...
class Game:
    ...
    def mouse_card(self, mosx, mosy):
        ...
        if (mosx >= 200 and mosx <= (500)) and (mosy >= 50 and mosy <= (545)):
            self.click_list.append(1)
        if (mosx >= 500.1 and mosx <= (800)) and (mosy >= 50 and mosy <= (545)):
            self.click_list.append(2)
        if (mosx >= 800.1 and mosx <= (1100)) and (mosy >= 50 and mosy <= (545)):
